...
class ModelOverPiker {
  ...
  calcTeamScores() {
    ...
    map =
      this.panelSelections[1].options[this.panelSelections[1].selectedIndex];
    adc =
      this.panelSelections[3].options[this.panelSelections[3].selectedIndex];
    ...
    if (isTierSelected) {
      tier =
        this.panelSelections[0].options[this.panelSelections[0].selectedIndex];
    }
...
class ViewOverPiker {
  constructor() {
    ...
    //Border
    this.teamSeparator = this.createElement(
      "div",
      "team-heroes-selection-line-between"
    );
